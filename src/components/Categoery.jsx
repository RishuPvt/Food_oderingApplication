...
const prevslide=()=>{
  ...
  return (
    <>
      <section className="categoery-box w-full h-[256px] flex justify-around">
        <div className="categoery-innerbox h-full w-4/5 ">
          <div className="categoery-title">
            <h2>What's on your mind?</h2>
            <span className="flex gap-5" >
              <FaRegArrowAltCircleLeft  onClick={prevslide} className="cursor-pointer"/> <FaRegArrowAltCircleRight onClick={nextslide} className="cursor-pointer"/>
            </span>
          </div>
    <div className="w-full overflow-hidden" >
          <div className="categoery-items  h-[200px]  inline-flex" style={{transform:`translatex(-${slide*10}%)`}}>
