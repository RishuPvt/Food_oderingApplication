      ...
      <section className="categoery-box w-full h-[520px] flex justify-around mt-12">
        <div className="categoery-innerbox h-full w-4/5 shadow-lg ">
          <div className="categoery-title">
            <h2>Top restaurant chains in Noida 1</h2>
            <span className="flex gap-5">
              <FaRegArrowAltCircleLeft onClick={PrvSlide} className="cursor-pointer" />{" "}
              <FaRegArrowAltCircleRight onClick={nextSlide} className="cursor-pointer" />
            </span>
          </div>
          <div className="w-full overflow-hidden">
            <div className="categoery-items2  h-[307]  inline-flex " 
            style={{ transform: `translatex(-${Slide * 10}%)` }}>
              <div className=" w-[260px] ">
                <CardImage apiKey="r9vj1kuismiimtqb2nhl" />
                <h1 className="discount font-bold">₹600 for two</h1>
                <h2 className="name font-normal">Barbeque Nation</h2>
                <h3 className="rating font-light"><MdOutlineStarRate/><span className="font-bold">4.1.</span> 50-55 mins</h3>
              ...
              <div className=" w-[260px]">
                ...
                <h2 className="name font-normal">Daily Kitchen - Homely Meals</h2>
                <h3 className="rating font-light"><MdOutlineStarRate/><span className="font-bold">4.1.</span> 50-55 mins</h3>
              ...
              <div className=" w-[260px]">
                ...
                <h3 className="rating font-light"><MdOutlineStarRate/><span className="font-bold">4.1.</span> 30-35 mins</h3>
                <h3 className=" nickname font-light">pizzas</h3>
              ...
              <div className=" w-[260px]">
                ...
                <h3 className="rating font-light"><MdOutlineStarRate/><span className="font-bold">4.1.</span> 35-45 mins</h3>
